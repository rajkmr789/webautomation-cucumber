...
public class loginSteps {
    ...
    public void user_launches_the_InstaBee_portal_on_browser()
    ...
    public void user_enters_the_valid_phone_number_registered_with_the_player_and_hit_verify()
            throws InterruptedException {
    ...
    public void user_hit_submit_button_to_confirm_2FA_popup()
            throws InterruptedException {
