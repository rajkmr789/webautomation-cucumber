...
public class companyPage {
	public final String emailAddressEmployee = "auto"
	...
	public void selectNameBusinessTypeAndCategoryAndClickCreateCompany() throws InterruptedException {
		...
		Select businessTypeDropdown = new Select(
				driver.findElement(By.xpath("//select[contains(@id,'data.business_type_id')]")));
	...
	public void updateCompanySettings() throws InterruptedException {
		...
		Select businessTypeDropdownUpdate = new Select(
				driver.findElement(By.xpath("//select[contains(@id,'data.business_type_id')]")));
		...
		Select businessTypeDropdownUpdateValidation = new Select(
				driver.findElement(By.xpath("//select[contains(@id,'data.business_type_id')]")));
		assertEquals("Furniture", businessTypeDropdownUpdateValidation.getFirstSelectedOption().getText());
		Select stateDropdownUpdateValidation = new Select(
				driver.findElement(By.xpath("//select[contains(@id,'data.state_id')]")));
